...
export function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex h-11 items-center gap-1 rounded-2xl border border-white/10 bg-white/5 p-1 backdrop-blur-xl shadow-[0_1px_0_0_rgba(255,255,255,0.06)_inset]",
        className
      )}
      {...props}
    />
...
export function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        "inline-flex h-9 items-center justify-center gap-2 rounded-xl px-4 text-sm font-medium text-muted-foreground transition-all duration-200",
